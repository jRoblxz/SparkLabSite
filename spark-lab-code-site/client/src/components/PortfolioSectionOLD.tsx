  ...
  const projects = [
    {
      ...
      description:
        "Plataforma profissional desenvolvida para gerenciar e otimizar processos de avaliação e seleção em peneiras de futebol.",
    ...
    },
    {
      ...
      description:
        "Sistema inovador de visão computacional capaz de mapear e rastrear jogadores de hóquei em tempo real.",
    ...
    //   description:
    //     "Aplicação web interativa focada na experiência do usuário e gerenciamento dinâmico de estados.",
