...
import { motion } from 'framer-motion';
import { Code, Smartphone, Database, ScanEye } from 'lucide-react';
...
export default function ServicesSection() {
  const services = [
    ...
    },
    {
      ...
      description: 'Arquitetura e desenvolvimento de ferramentas internas para otimizar fluxos de trabalho e processos educacionais/corporativos.',
      color: '#f59e0b',
    },
    {
      icon: ScanEye,
      title: 'IA & Visão Computacional',
      description: 'Soluções inovadoras de automação e análise de dados utilizando Python e ferramentas avançadas como OpenCV e YOLO.',
      color: '#10b981',
    },
  ];
  ...
  return (
    <section id="services" className="py-24  bg-[#1e1c1c] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          whileInView={{ opacity: 1, y: 0 }}
